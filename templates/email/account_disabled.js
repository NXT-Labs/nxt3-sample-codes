exports.accountDisabledEmailTemplate = (adminEmail) => {
  return `
<!doctype html>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:helvetica;font-size:20px;line-height:1;text-align:left;color:#F45E43;">Your account has been disabled please contact admin at ${adminEmail} for further details</div>
                      </td>
                    </tr>
                  </tbody>
                </table>
